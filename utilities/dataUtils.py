# DataGenerator for NLP, copied elsewhere - will try to recite when possible
...
def pad_sequences(sequences, pad_token, nlevels=1):
    if nlevels == 1:
        ...
        for seq in sequences:
            ...
            sp, sl = _pad_sequences(seq, pad_token, max_length_word)
            sequence_padded += [sp]
            sequence_length += [sl]
